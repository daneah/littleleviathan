...
from main.views import HomeView, AlbumListView, AlbumDetailView, SongListView, SongDetailView
...
urlpatterns = patterns(
    ...
    url(r'^album/(?P<album_code>[\w\-]+)/songs/$', SongListView.as_view(), name='songs'),
